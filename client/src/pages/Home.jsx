...
const Home = () => {
  ...
  // Initializing the SwiperCore 👇
  SwiperCore.use([Navigation]);

  console.log(offerListings);

  // After these states should create this useEffect to fetch the listings 👇
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        <h1 className='text-slate-700 font-semibold text-3xl lg:text-6xl'>Find your next{' '}
